...
// size; Difficult reuses the original (pre-2x) medium fish size at 2x
// medium's current speed.
export const FISH_CONFIG: Record<Difficulty, FishConfig> = {
  ...
  difficult: { spawnMsRange: [450, 950], speedRange: [190, 320], sizeRange: [26, 36], goldChance: 0.12 },
};
